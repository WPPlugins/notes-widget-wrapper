...
class Notes_Widget_Wrapper_Public {
	...
	public function notes_widget_wrapper_update_callback($params){
		...
		if (!empty($widget_opt[$widget_num]['nww_use_notes_widget_style'])) {
			...
			$thumb_tack_colour 	= isset($widget_opt[$widget_num]['nww_thumb_tack_colour']) ? sanitize_html_class($widget_opt[$widget_num]['nww_thumb_tack_colour']) : 'red';
			$background_colour 	= isset($widget_opt[$widget_num]['nww_background_colour']) ? sanitize_html_class($widget_opt[$widget_num]['nww_background_colour']) : 'yellow';
			$text_colour 				= isset($widget_opt[$widget_num]['nww_text_colour']) ? sanitize_html_class($widget_opt[$widget_num]['nww_text_colour']) : 'red';
			$font_size					= isset($widget_opt[$widget_num]['nww_font_size']) ? sanitize_html_class($widget_opt[$widget_num]['nww_font_size']) : 'normal';
			...
			$wrapper_css				= isset($widget_opt[$widget_num]['nww_wrapper_css']) ? esc_html($widget_opt[$widget_num]['nww_wrapper_css']) : '';
			$font_style					= isset($widget_opt[$widget_num]['nww_font_style']) ? esc_html($widget_opt[$widget_num]['nww_font_style']) : 'kalam';
